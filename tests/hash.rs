...
fn test_hash_hardware() {
    ...
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "236ebffb019ea9b19c9ff160775bc7a6ed090fce7103a32ee582d24a81db6960");

    //1=groestl
    input = byte_string::string_to_u8_array("5468697320697320612074657374");
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "a084f01d1437a09c6985401b60d43554ae105802c5f5d8a9b3253649c0be6605");

    //2=JH (xmr-stak input "This is a test66")
    input = byte_string::string_to_u8_array("54686973206973206120746573743636");
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "21fb4137747541810d5f8ce821b6dacf68eb3051778e68b5bcd990c21fa08fd6");

    //3=Skein (xmr-stak input "This is a test6")
    input = byte_string::string_to_u8_array("546869732069732061207465737436");
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "bfabcc134608782e8f7322972dba801267f841535372741b554356045910f614");
    ...
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "5de3f18eff8271adbd3b9848b49d71230d696c7ba6c735554af8e15330ab881b");
    ...
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "55b4a3163cb2b0720b3b83bee0067dd088891d7fa116fe4c7250f004011c2d99");
    ...
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "c8dcfae5547a922eba99a65692636b2fd17745b62fddb588fe684ee2f80bd8fd");
    ...
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "038228f36441187229333dd71d3f1b672335ec526d2101cc5fc700692c6aa9cb");
}
...
fn test_hash_from_cryptonote_white_paper_hardware() {
    ...
    assert_eq!(hash::hash_alloc_scratchpad(&input, &aes), "eb14e8a833fac6fe9a43b57b336789c46ffe93f2868452240720607b14387e11");
